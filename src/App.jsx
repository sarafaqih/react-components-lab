import './App.css'
import WeatherForecast from './componenets/WeatherForecast/WeatherForecast';
...
const App = () => {
  ...
  return (
    ...
    <section>    
      <WeatherForecast day={weather.day} img={weather.img} imgAlt={weather.imgAlt} conditions={weather.conditions} time={weather.time} />
    </section>
  </div>
)}
  </>
